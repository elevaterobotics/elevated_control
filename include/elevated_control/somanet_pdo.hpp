...
struct InSomanet50t {
  ...
  std::int32_t FollowingError;              // 0x60F4:00  32 bits  byte 13
  std::int32_t SecondaryPosition;           // 0x2111:02  32 bits  byte 17
  std::int32_t SecondaryVelocity;           // 0x2113:02  32 bits  byte 21
  std::uint16_t AnalogInput1;               // 0x2401:00  16 bits  byte 25
  std::uint16_t AnalogInput2;               // 0x2402:00  16 bits  byte 27
  std::uint16_t AnalogInput3;               // 0x2403:00  16 bits  byte 29
  std::uint16_t AnalogInput4;               // 0x2404:00  16 bits  byte 31
  std::uint32_t UserMISO;                   // 0x2702:00  32 bits  byte 33
  std::uint32_t DigitalInputs;              // 0x60FD:00  32 bits  byte 37
  std::uint32_t TuningStatus;               // 0x2704:00  32 bits  byte 41
  std::uint32_t Timestamp;                  // 0x20F0:00  32 bits  byte 45
  std::int32_t PositionDemandInternalValue; // 0x60FC:00  32 bits  byte 49
  std::int32_t VelocityDemandValue;         // 0x606B:00  32 bits  byte 53
  std::int16_t TorqueDemand;                // 0x6074:00  16 bits  byte 57
  std::int32_t DCLinkVoltage;               // 0x6079:00  32 bits  byte 59
};

// RxPDO (host → drive) — 39 bytes
...
struct OutSomanet50t {
  ...
  std::int32_t MotorDriveSubcommand;        // 0x2012:01  32 bits  byte 35
};
